...
def get_and_transform_data(indices):
    ...
    for i in indices:
        ...
        Income_st.rename(index={'ttm': '6/30/2021'}, inplace=True)  # Rename ttm in index columns to end of the year
        Income_st = Income_st[Income_st.columns[:-4]]  # remove last 5 irrelevant columns
        Income_st['ind'] = i
